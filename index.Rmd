...
- Creating branches must be done in terminal or in some other Git UI or at GitHub.
...
## What is R project and what is GitHub repo

- R project is standalone folder where your 
