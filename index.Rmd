...
subtitle: "Teaduse metodoloogia ja eetika biomeditsiinis, Tartu 2021"
author: "Taavi Päll"
date: "2021/09/29"
output:
...
<br><br>
<div class=center>
<img src="img/rmarkdown.png" style="max-width:15%;">
...
- __Collaboration__: platform and interface designed to enable collaboration (in software development).
...
- File -> New Project
    ...
    - Fill in the info:
         ...
         - Create as a subdirectory of: Browse and create a new folder called e.g. `rstats2021`
